$(function(){	
	if($('#title-breadcrumb-option-demo').length>0){
		var stickyOffset = $('#title-breadcrumb-option-demo').offset().top;
		$(window).scroll(function(){
			  var sticky = $('#title-breadcrumb-option-demo'),
	...
	$('ul#side-menu li.active').each(function(index, element){
...
//    });
    ...
    var setTheme = function (menu_style, style, header, color) {
        ...
        $('#theme-change').attr('href', $('#theme-change').attr('base_url') + 'css/themes/'+ style + '/' + color + '.css');
    }
